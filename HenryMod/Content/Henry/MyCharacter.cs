...
namespace HANDMod.Modules.Survivors
{
    internal class MyCharacter : SurvivorBase
    {
        ...
        public const string HENRY_PREFIX = HandPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_";
        ...
        {
            bodyName = "HenryBody",
            bodyNameToken = HandPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_NAME",
            subtitleNameToken = HandPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_SUBTITLE",
