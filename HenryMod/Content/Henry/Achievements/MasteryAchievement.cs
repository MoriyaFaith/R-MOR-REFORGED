...
namespace HANDMod.Modules.Achievements
{
    ...
    {
        public override string AchievementTokenPrefix => HandPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_MASTERY";
        ...
        public override string PrerequisiteUnlockableIdentifier => HandPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_UNLOCKABLE_REWARD_ID";
