...
namespace HANDMod
{
    internal class LanguageTokens
    {
        public LanguageTokens()
        {
            ...
            LanguageAPI.Add(prefix + "UTILITY_NEMESIS_DESC", "Temporarily become <style=cIsHealth>unable to sprint</style> while dealing <style=cIsDamage>50% extra damage</style>.");
