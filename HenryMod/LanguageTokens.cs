...
namespace HANDMod
{
    internal class LanguageTokens
    {
        public LanguageTokens()
        {
            ...
            LanguageAPI.Add(prefix + "UTILITY_NEMESIS_DESC", "Temporarily <style=cIsHealth>reduce your movement speed</style> while dealing <style=cIsDamage>50% extra damage</style>.");
